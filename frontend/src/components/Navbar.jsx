...
export default function Navbar() {
  ...
  return (
    <nav
      className="bg-slate-700 shadow-sm sticky top-0 z-50 border-b
                    border-gray-100"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-7">
            {navLinks.map((l, i) => (
              <Link key={i} to={l.to} className={isActive(l.to)}>
                {l.label}
              </Link>
            ))}
          </div>
                        ...
                        {dropdownItems.map((item, i) => (
                          <Link
                            ...
                            className="flex items-center gap-3 px-4
                                       py-3 hover:bg-gray-50 transition
                                       group"
                          >
                            <div
                              className="w-8 h-8 rounded-lg
                                            bg-gray-100 group-hover:bg-[#2E86AB]/10
                                            flex items-center justify-center
                                            text-gray-400
          ...
          <button
            className="md:hidden text-gray-600 p-2 rounded-lg
            ...
            >
              <div
                className="w-10 h-10 rounded-xl bg-linear-to-br
                              from-[#1E3A5F] to-[#2E86AB] flex items-center
