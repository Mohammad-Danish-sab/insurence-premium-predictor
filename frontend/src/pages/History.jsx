...
export default function History() {
  ...
  const [downloading, setDownloading] = useState(null); // ← Fix 1: added
  ...
  const filtered = predictions.filter((p) => {
    const matchFilter = filter === "all" || p.input?.insurance_type === filter;
    const matchSearch =
      search === "" ||
        ...
        >
          {loading ? (
            ...
            <div className="text-center py-20 text-gray-400">
              ...
              <Link
                to="/predict"
                className="inline-block mt-4 text-[#2E86AB] text-sm
                           hover:underline"
              >
                Get a quote →
              </Link>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <button
                              ...
                              className="text-[#2E86AB] hover:text-[#1E3A5F]
              ...
              >
                {filtered.map((p) => (
                  <div key={p._id} className="p-4">
                    ...
                    <p className="text-2xl font-bold text-[#2E86AB] mb-2">
                      {formatINR(p.result?.predicted_premium || 0)}
                    </p>
                    ...
                    <div className="flex gap-3">
                      ...
                      <Link
                        to={`/report/${p._id}`}
                        className="flex items-center gap-1.5 text-xs
                                   text-gray-500 font-medium hover:underline"
                      >
                        👁 View
                      </Link>
                      <button
          ...
          <div className="flex items-center justify-center gap-3 mt-6">
            <button
              ...
              className="p-2 rounded-full border border-gray-200
                         hover:bg-gray-100 disabled:opacity-40 transition"
            >
